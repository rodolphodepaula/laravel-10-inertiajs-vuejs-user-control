  ...
  <authenticated-layout>
    ...
    <div class="flex justify-end bg-gray-100 px-4 py-3 rounded-lg shadow space-x-2">
      <div class="inline-flex space-x-2">
        <button class="flex items-center btn-link hover:text-blue-600 hover:underline" @click="openEditCompanyModal">
    ...
    <form @submit.prevent="submit">
      <Filter>
        <template #inputFilter>
          ...
          <TextInput placeholder="Nome ou Email" id="name" type="text" class="mt-1 block w-full" v-model="companies.name" />
        </template>
        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
          ...
          <Table :paginator="paginator">
            <template #headColumns>
              ...
              <THead type="normal" label="Data Cadastro" />
